...
<!--titulo principal do jogo-->
    ...
    <hr>
    <!-- formulário para o usuario definir o numero de questões e iniciar o jogo -->
    <form action="index.php?route=start" method="post">
       ...
       <input type="number" class="form_control" id="text_total_questions" name="text_total_questions" value="10" min="1" max="20"> </h3>
